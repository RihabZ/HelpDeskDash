...
//requête (nombre de tickets par technicien par mois)ll manager 
 ...
 // mta3 maanger 
 long countTotalNonArchivedTickets();
 long countNonArchivedTicketsByStatus(String status);
 long countNonArchivedTicketsToBeRealized();
 long countNonArchivedTicketsRealized();
 long countNonArchivedTicketsPending() ;
 long countNonArchivedTicketsCancelled();
 long countNonArchivedTicketsBlocked();
 // mta3 tech 
 long countTotalNonArchivedTicketsForLoggedInTechnician() ;
 long countNonArchivedTicketsForLoggedInTechnicianByStatus(String status);
 long countNonArchivedTicketsToBeRealizedForLoggedInTechnician();
 long countNonArchivedTicketsRealizedForLoggedInTechnician() ;
 
 //mt3 dashbord Tech
 Long totalTicketsTechnicien();
 Long todoTicketsTechnicien();
}